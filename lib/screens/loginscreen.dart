    ...
    return Scaffold(
      ...
      body: Column(
       children: <Widget>[
              ...
              Padding(padding: EdgeInsets.fromLTRB(50, 0, 0, 0),child:  Headline(title: 'Welcome back'),),
             Row(
                     ...
                     child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text('Login',style: TextStyle(fontWeight: FontWeight.bold,fontFamily: 'Raleway',fontSize: 18.0,),),
                            CustomInput(),
                            CustomPassword(),
                            TextButton(onPressed: null, child: const Text('Forgot Password?',style: TextStyle(color: Color(0xff5956E9)))),
                            ElevatedButton(onPressed: (){},
                                ...
                                child: Text('Log In')),
                            Center(
                              child: TextButton(onPressed: null, child: const Text('Create account',style: TextStyle(color: Color(0xff5956E9),fontSize: 17.0))),
                            )
                          ],
                        ),
                     )
